...
metadata-files: 
  ...
  - "../_page_meta.yml"
abstract: |
    The conversation delves into advanced techniques and practical considerations for fine-tuning large language models, comparing tools, discussing model precision and optimization, and exploring best practices for effective training and deployment.
...
**[00:00](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=0s) Axolotl vs. Hugging Face AutoTrain**  
Zach discusses the differences between Axolotl and Hugging Face AutoTrain.

**[02:06](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=126s) Becoming an Effective LLM Engineer**  
Zach emphasizes the importance of hands-on experience in training models for effective learning.

**[07:13](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=433s) Getting Feedback from Experts**  
Participants explore ways to reach out to experts for valuable feedback.

**[09:44](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=584s) Datasets for Finetuning LLMs**  
Discussion on the use of synthetic data, Hugging Face datasets, and other sources for fine-tuning LLMs.

**[14:23](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=863s) Advantage of FSDP**  
Zach explains how FSDP was crucial for fine-tuning LLama 3 across multiple GPUs.

**[15:22](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=922s) Advantages of Using torch.compile**  
...
**[17:34](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=1054s) Training Inference Precision**  
Zach talks about the challenges of training models in bf16 precision.

**[19:18](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=1158s) Downsides of FSDP**  
...
**[25:24](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=1524s) Fine-tuning vs. Frontier Models**  
Discussion on the possibility of fine-tuned models beating frontier models.

**[27:27](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=1647s) Ensuring Proper Model Functioning During Inference**  
Zach advises using the Hugging Face pipeline to test the finetuned model to ensure proper behavior.

**[29:51](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=1791s) Running 8 Billion Parameters Model on a 4090**  
Participants discuss techniques like AWQ, TRTllm, and vLLM for running large models locally.

**[31:01](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=1861s) Training Models in INT-8**  
Training in INT-8 and fp8 is unstable, leading to the preference for bf16, though some companies are exploring fp8.

**[34:30](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=2070s) Accelerate Failure Case**  
Zach discusses the robustness and resilience of Accelerate in demanding workloads using thousands of GPUs.

**[35:58](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=2158s) Relevance of Chinchilla Scaling Laws**  
Chinchilla scaling laws remain relevant, and extended training offers significant benefits.

**[38:22](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=2302s) Relevance of TensorFlow**  
...
**[41:50](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=2510s) Training on Apple Silicon**  
Apple Silicon is suitable for inference but not ideal for training, with NVIDIA GPUs being recommended.

**[45:18](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=2718s) Serving Multiple LoRAs with Accelerate**  
vLLM and LoRAX can be used to serve multiple LoRAs.

**[48:56](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=2936s) Mixture of LoRAs**  
A discussion on using LoRAs in a mixture setting with a router.

**[51:35](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=3095s) Deciding on a Fine-tuning Project**  
...
**[53:19](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=3199s) Choosing Model Sweet Spot**  
...
**[58:31](https://www.youtube.com/watch?v=TrnJG_ve6R0&t=3511s) Phi-3’s Popularity for Finetuning**  
...
The following practices can significantly enhance the learning journey in LLM engineering:

- Engaging in self-initiated projects and experiments
- Developing and testing small-scale projects
- Seeking guidance from experts and the community
- Ensuring substantial experimentation before seeking feedback
- Recreating existing solutions for various problems, as originality is not mandatory

### Dataset Sources for Training

Several sources provide datasets suitable for training:

- Kaggle challenge datasets
- Hugging Face datasets
- Synthetic data generation

It is recommended to use datasets that evolve over time for effective training.

### Distributed Training

Techniques such as Fully Sharded Data Parallelism (FSDP) and DeepSpeed facilitate distributed training, with DeepSpeed offering greater flexibility. These techniques are advantageous when the model exceeds the GPU's VRAM capacity or barely fits, as they enable the use of additional GPUs for loading gradients.

### Serving Multiple LoRAs

Techniques like LoRAX and vLLM can be employed to serve multiple LoRAs. The following code snippet illustrates how to serve a specific LoRA for a particular request:
...
- Define the available budget to determine the type and size of the model
- Establish a quality threshold and train the smallest model that meets the desired quality
- Consider inference costs, which are more significant than training costs
...
<br>[17:05] Zack Mueller: Yes. So it feeds up train time. Mostly it's throughput optimizations, more than memory optimizations.
...
<br>[23:33] Zack Mueller: Yeah, they're super slim. And they use like a fourth of the wattage. So and also they have more CUDA cores available to them for actually to be used by for training. However, if you can't find them, which a lot of people can't, you can get by, right? I've done my job. granted my job has had limited training but i've done my job with just two 40 90s to do four iterations on laura tuning uh llama 3 8 billion it's about somewhere between four to six hours to get full training done yeah um it's
...
<br>[41:20] Hamel Husain: You just convinced me not to use it.
