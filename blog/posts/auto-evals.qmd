...
For the past three years, we have answered most questions about AI evals with the same advice: look at your data.[^teaching] In practice, looking at your data means error analysis[^ea], where you read your production traces (or logs) and catalog how your product fails. Reviewing traces also changes what you look for. You need criteria to grade outputs, but grading outputs is how you discover your criteria, a phenomenon known as criteria drift.[^drift] For this reason, we argued against completely outsourcing evals to an LLM.[^revenge]

Recent updates to popular eval tools nudge the other way. Braintrust, Arize, and LangSmith have each shipped an agent (Loop, Alyx, and Engine) that reads your production traces and reports what is failing.[^tools] Coding agents have become capable enough to attempt the same job from a folder of log files or traces. We believe in using AI in any workflow where it helps. However, the temptation with these tools is to take the human out of the loop entirely. How much can these systems catch on their own, and what do they miss?
...
_P.S. Want to learn more about Evals? Check out our [AI Evals course](https://maven.com/parlance-labs/evals?promoCode=parlance-c6){target="_blank"}. It's a live cohort with hands on exercises and office hours. Here is a [25% discount code](https://maven.com/parlance-labs/evals?promoCode=parlance-c6){target="_blank"} for readers._
