...
:::{.testimonial-section}
::: {.hero-banner}
### Practical consulting that improves your AI, reliably.
:::
:::
...
1. Improving AI products by implementing domain-specific eval systems, optimizing RAG, and fine-tuning.
2. Building tools and infrastructure to speed up your AI development process.
3. Upskilling your team with workshops and focused debugging sessions.

## Solutions

See [this page](./services.qmd) for info on our consulting services.
